            ...
            Row(
              ...
              children: [
                ...
                Column(
                  crossAxisAlignment: CrossAxisAlignment.end,
                  children: [
                    Text('13:20', style: TextStyle(color: Colors.blue.shade700, fontSize: 12)),
                    Text('Athens', style: TextStyle(color: Colors.blue.shade700, fontSize: 12)),
                    const SizedBox(height: 5),
                    Text('8:20', style: TextStyle(color: Colors.black54, fontSize: 12)),
                    Text('Buenos Aires', style: TextStyle(color: Colors.black54, fontSize: 12)),
                  ],
                ),
              ],
            ),
        ...
        children: [
          Padding(
            ...
            child: Row(
              ...
              children: [
                const Text('Todays tasks', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                ElevatedButton(
                  onPressed: () {},
                  ...
                  child: const Text('Reminders', style: TextStyle(fontSize: 12)),
                ),
              ],
            ),
          ),
          ...
          Container(
            ...
            child: const Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('Study Session', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                SizedBox(height: 10),
                Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    ...
                    Text('5:30 PM End', style: TextStyle(fontSize: 14)),
                  ],
                )
              ],
            ),
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Human-computer interaction Deadline', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18)),
                const SizedBox(height: 10),
                Align(
                  alignment: Alignment.centerRight,
                  child: Column(
                    children: [
                      const Text('23:59', style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16)),
                      Text('Ends in 3 hours', style: TextStyle(fontSize: 12, color: Colors.black54)),
                    ],
                  ),
                ),
              ],
        ...
        Padding(
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                Text('NOV', style: TextStyle(color: Colors.grey.shade700)),
